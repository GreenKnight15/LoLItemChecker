...
*/
    ...
    $scope.showDownload = function(ev) {
        ...
        $mdDialog.show(
            ...
            .content('Save File in League of Legends-Config-Global-Recommended\ or to be Champion Specific add the file to League of Legends-Config-Champions-{championKey}-Recommended\     If the folders are not there make them(*Mac* Global/Recommended)')
